...
@Component({
  ...
  templateUrl: './mon-compte-utilisateur.component.html',
  styleUrls: ['./mon-compte-utilisateur.component.css']
})
export class MonCompteUtilisateurComponent implements OnInit {
